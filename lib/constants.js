...
export const TYPE_PREFIX = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type';
export const ERROR_TYPE = 'http://redpencil.data.gift/vocabularies/deltas/Error';
export const STATUS_PREFIX = 'http://www.w3.org/ns/adms#status';
export const TASK_OPERATION_PREFIX = 'http://redpencil.data.gift/vocabularies/tasks/operation';
